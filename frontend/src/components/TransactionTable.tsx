          ...
          <tbody className="divide-y divide-slate-800">
            {transactions.map((transaction) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span
                    className={`inline-flex items-center px-2.5 py-1 rounded text-xs font-medium ${transaction.type === 'income'
                ...
                <td className="px-6 py-4 text-right">
                  <span
                    className={`text-sm font-semibold tabular-nums ${transaction.type === 'income'
                      ? 'text-green-400'
                      : 'text-red-400'
                      }`}
                  >
