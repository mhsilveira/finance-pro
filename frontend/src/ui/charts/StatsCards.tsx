...
export default function StatsCards({ monthlyTrends, averageDailySpending }: StatsCardsProps) {
  ...
  const worstMonth = monthlyTrends.reduce((worst, current) => 
  ...
  return (
    <div className="grid-3" style={{ marginBottom: 24 }}>
      ...
      <Card>
        ...
        <Text size={20} weight={600} style={{ color: savingsRate >= 20 ? 'var(--success)' : savingsRate >= 10 ? '#f59e0b' : 'var(--danger)' }}>
      ...
      <Card>
        ...
        <Text size={18} weight={600} style={{ color: trend > 0 ? 'var(--success)' : trend < 0 ? 'var(--danger)' : 'var(--muted)' }}>
