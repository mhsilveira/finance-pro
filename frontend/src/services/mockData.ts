...
const mockTransactionsData: Transaction[] = [
	...
	},
	{
		...
		monthYear: "2024-01",
		name: "Uber",
		description: "Viagem para trabalho",
		category: "Transporte",
		amount: 120,
		type: "expense",
	},
	...
	{
		id: "27",
		date: "2024-04-20T17:30:00.000Z",
		monthYear: "2024-04",
		name: "Uber",
		description: "Viagem para aeroporto",
		category: "Transporte",
		amount: 150,
		type: "expense",
	},
	...
	},
	{
		...
		monthYear: "2024-06",
		name: "Uber",
		description: "Viagem para shopping",
		category: "Transporte",
		amount: 85,
		type: "expense",
	},
	...
	{
		id: "48",
		date: "2024-06-30T16:20:00.000Z",
		monthYear: "2024-06",
		name: "Freelance Design",
		description: "Projeto de logo",
		category: "Freelance",
		amount: 1800,
		type: "income",
	},
...
export class MockService {
	...
	async getReportData(monthYear?: string): Promise<ReportData> {
		...
		// Top transactions
		const topTransactions = filteredTransactions.sort((a, b) => b.amount - a.amount).slice(0, 10);

		// Average daily spending
		const expenseTransactions = filteredTransactions.filter((t) => t.type === "expense");
		const totalDays = new Set(expenseTransactions.map((t) => t.date.slice(0, 10))).size;
		const averageDailySpending =
			totalDays > 0 ? expenseTransactions.reduce((sum, t) => sum + t.amount, 0) / totalDays : 0;
