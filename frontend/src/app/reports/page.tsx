...
import { Card, H1, Text, Stack, Select, Input } from '@/ui/design/atoms';
...
export default function ReportsPage() {
  ...
  const { 
    ...
    loading 
  } = useReports(selectedMonth || undefined);
  ...
  return (
    <div className="container">
      ...
      <Card style={{ marginBottom: 24 }}>
        <Text size={18} weight={600} style={{ marginBottom: 16 }}>Tendências Mensais</Text>
      ...
      <Card style={{ marginBottom: 24 }}>
        <Text size={18} weight={600} style={{ marginBottom: 16 }}>Gastos por Categoria</Text>
        <table className="table">
          <thead>
            <tr>
              <th>Categoria</th>
                ...
                <td>
                  <Text 
                    ...
                    style={{ 
                      ...
                      background: item.type === 'income' ? 'rgba(61, 220, 151, 0.1)' : 'rgba(255, 107, 107, 0.1)',
                      padding: '2px 8px',
                      borderRadius: 4,
      ...
      {/* Top Transações */}
      <Card>
        <Text size={18} weight={600} style={{ marginBottom: 16 }}>Maiores Transações</Text>
        <table className="table">
          <thead>
            <tr>
              <th>Descrição</th>
            ...
            {topTransactions.slice(0, 10).map(transaction => (
              <tr key={transaction.id}>
                <td>
                  ...
                  <div className="muted" style={{ fontSize: 12 }}>{transaction.description}</div>
                </td>
                ...
                <td>
                  <Text 
                    ...
                    style={{ 
                      ...
                      background: transaction.type === 'income' ? 'rgba(61, 220, 151, 0.1)' : 'rgba(255, 107, 107, 0.1)',
                      padding: '2px 8px',
                      borderRadius: 4,
                      display: 'inline-block'
                    }}
